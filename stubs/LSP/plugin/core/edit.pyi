import sublime
from ...protocol import AnnotatedTextEdit, ApplyWorkspaceEditResult, CreateFile, DeleteFile, Position, RenameFile, SnippetTextEdit, TextDocumentEdit, TextEdit, WorkspaceEdit
...
def is_text_document_edit(document_change: TextDocumentEdit | CreateFile | RenameFile | DeleteFile) -> TypeGuard[TextDocumentEdit]: ...
...
def show_summary_message(window: sublime.Window, result: ApplyWorkspaceEditResult, summary: WorkspaceEditSummary) -> None: ...
