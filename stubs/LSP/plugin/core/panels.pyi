import sublime
from .types import (
    PANEL_FILE_REGEX as PANEL_FILE_REGEX,
    PANEL_LINE_REGEX as PANEL_LINE_REGEX,
)
...
class PanelManager:
    ...
    def update_workspace_edit_panel_buttons(
        self, phantoms: Iterable[sublime.Phantom]
    ) -> None: ...
