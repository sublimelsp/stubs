import sublime
import weakref
from ...protocol import AnnotatedTextEdit as AnnotatedTextEdit, ApplyWorkspaceEditParams, ApplyWorkspaceEditResult as ApplyWorkspaceEditResult, ChangeAnnotation as ChangeAnnotation, ChangeAnnotationIdentifier as ChangeAnnotationIdentifier, CodeAction, CodeActionKind, CodeActionTriggerKind, Command, ConfigurationParams, CreateFile as CreateFile, DeleteFile as DeleteFile, Diagnostic as Diagnostic, DiagnosticOptions as DiagnosticOptions, DiagnosticServerCancellationData as DiagnosticServerCancellationData, DidChangeWatchedFilesRegistrationOptions as DidChangeWatchedFilesRegistrationOptions, DocumentLink, DocumentUri, ExecuteCommandParams, FileEvent as FileEvent, FileSystemWatcher as FileSystemWatcher, InitializeParams, LSPAny, LSPObject as LSPObject, Location, LocationLink, LogMessageParams, MessageActionItem as MessageActionItem, PreviousResultId as PreviousResultId, ProgressParams, PublishDiagnosticsParams, Range, RegistrationParams, RenameFile as RenameFile, ShowDocumentParams, ShowDocumentResult, ShowMessageParams, ShowMessageRequestParams, SignatureHelpTriggerKind, SnippetTextEdit as SnippetTextEdit, TextDocumentContentRefreshParams, TextDocumentEdit as TextDocumentEdit, TextDocumentSyncKind, TextEdit as TextEdit, UnregistrationParams, WatchKind as WatchKind, WorkDoneProgressCreateParams, WorkDoneProgressEnd as WorkDoneProgressEnd, WorkDoneProgressReport as WorkDoneProgressReport, WorkspaceDocumentDiagnosticReport, WorkspaceEdit, WorkspaceFolder as LspWorkspaceFolder, WorkspaceFullDocumentDiagnosticReport as WorkspaceFullDocumentDiagnosticReport
from ..api import APIHandler as APIHandler, AbstractPlugin as AbstractPlugin, LspPlugin as LspPlugin, PostResponseCallback as PostResponseCallback, notification_handler as notification_handler, request_handler as request_handler
...
from .edit import WorkspaceEditSummary as WorkspaceEditSummary, is_create_file as is_create_file, is_delete_file as is_delete_file, is_rename_file as is_rename_file, is_text_document_edit as is_text_document_edit
...
class Session(APIHandler, TransportCallbacks):
    ...
    def open_scratch_buffer(self, title: str, content: str, syntax: str, flags: sublime.NewFileFlags = ..., group: int = -1) -> Promise[sublime.View]: ...
    ...
    def apply_document_changes_async(self, document_changes: list[TextDocumentEdit | CreateFile | RenameFile | DeleteFile], change_annotations: dict[ChangeAnnotationIdentifier, ChangeAnnotation], *, label: str | None = None, is_refactoring: bool = False) -> Promise[ApplyWorkspaceEditResult]: ...
    def apply_workspace_edit_async(self, edit: WorkspaceEdit, *, label: str | None = None, is_refactoring: bool = False) -> Promise[tuple[ApplyWorkspaceEditResult, WorkspaceEditSummary]]:
        """
