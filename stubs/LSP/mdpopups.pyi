...
def version() -> tuple[int, int, int]:
    ...
    patch version.
    """
def show_popup(view: sublime.View, content: str, md: bool = ..., css: str | None = ..., flags: int = ..., location: int = ..., max_width: int = ..., max_height: int = ..., on_navigate: Callable[[str], None] | None = ..., on_hide: Callable[[str], None] | None = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> None:
    """
    Accepts Markdown and creates a Sublime popup. By default, the built-in Sublime syntax highlighter will be used for
    code highlighting.
    """
def update_popup(view: sublime.View, content: str, md: bool = ..., css: str | None = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> None:
    """
...
def is_popup_visible(view: sublime.View) -> bool:
    ...
    """
def add_phantom(view: sublime.View, key: str, region: sublime.Region, content: str, layout: sublime.PhantomLayout, md: bool = ..., css: str | None = ..., on_navigate: Callable[[str], None] | None = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> int:
    """
...
class Phantom:
    ...
    def __init__(self, region: sublime.Region, content: str, layout: sublime.PhantomLayout, md: bool = ..., css: str | None = ..., on_navigate: Callable[[str], None] | None = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> None: ...
...
def new_html_sheet(window: sublime.Window, name: str, contents: str, md: bool = ..., css: str | None = ..., flags: sublime.NewFileFlags = ..., group: int = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> sublime.HtmlSheet:
    """
    Accepts Markdown and creates a Sublime HTML sheet. By default, the built-in Sublime syntax highlighter will be used
    for code highlighting.
    """
def update_html_sheet(sheet: sublime.HtmlSheet, contents: str, md: bool = ..., css: str | None = ..., wrapper_class: str | None = ..., template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> None:
    """
...
def clear_cache() -> None:
    ...
    """
def md2html(view: sublime.View, markup: str, template_vars: dict[str, Any] | None = ..., template_env_options: dict[str, Any] | None = ...) -> str:
    """
    ...
    highlighting.
    """
def color_box(colors: list[str], border: str = ..., border2: str | None = ..., height: int = ..., width: int = ..., border_size: int = ..., check_size: int = ..., max_colors: int = ..., alpha: bool = ..., border_map: int = ...) -> str:
    """
    ...
    """
def color_box_raw(colors: list[str], border: str = ..., border2: str | None = ..., height: int = ..., width: int = ..., border_size: int = ..., check_size: int = ..., max_colors: int = ..., alpha: bool = ..., border_map: int = ...) -> bytes:
    """
...
def tint_raw(img: str | bytes, color: str, opacity: int = ...) -> bytes:
    ...
    """
def scope2style(view: sublime.View, scope: str, selected: bool = ..., explicit_background: bool = ...) -> dict[str, Any]:
    """
    ...
    """
def syntax_highlight(view: sublime.View, src: str, language: str | None = ..., inline: bool = ..., allow_code_wrap: bool = ..., language_map: dict[str, list[list[str]]] | None = ...) -> str:
    """
